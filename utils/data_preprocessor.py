...
class DataPreprocessor:
    def __init__(self, clip_lmdb_dir, out_lmdb_dir, n_poses, subdivision_stride, pose_resampling_fps,
        ...
        self.spectrogram_sample_length = data_utils.calc_spectrogram_length_from_motion_length(
    ...
    def _sample_from_clip(self, vid, clip):
        ...
        # skeleton resampling
        clip_skeleton = data_utils.resample_pose_seq(clip_skeleton, clip_e_t - clip_s_t,
        ...
        expected_audio_length = data_utils.calc_spectrogram_length_from_motion_length(
        ...
        for i in range(num_subdivision):
            ...
            if audio_end > clip_audio.shape[1]:  # correct size mismatch between poses and audio
                # print('expanding audio array, audio start={}, end={}, clip_length={}'.format(
