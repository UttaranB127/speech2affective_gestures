...
num_emo_dims = train_labels.shape[-1]

data_loader = dict(train_data=train_data_wav, train_labels=train_labels,
                   eval_data=eval_data_wav, eval_labels=eval_labels,
                   test_data=test_data_wav, test_labels=test_labels)
